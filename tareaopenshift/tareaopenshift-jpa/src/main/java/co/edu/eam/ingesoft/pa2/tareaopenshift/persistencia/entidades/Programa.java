...
@Table(name = "Programa")
@NamedQueries({
@NamedQuery(name=Programa.LISTA_PROGRAMAS, query="select a from Programa a")
})
public class Programa implements Serializable {
	...
	public boolean equals(Object obj) {
		if (obj instanceof Programa) {
			...
			if (this.nombrePrograma.equals(tmpPersona.nombrePrograma) && this.idFacultad.equals(tmpPersona.idFacultad)) {
				return true;
			} else {
				return false;
			}
